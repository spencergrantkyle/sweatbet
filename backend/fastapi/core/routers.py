...
from backend.fastapi.api.v1.endpoints import base, doc, message, auth, dashboard, landing, bet, bet_confirm, legal, settings, webhook, health, payment
...
def setup_routers(app: FastAPI):
    ...
    app.include_router(payment.router, prefix="", tags=["payments"])
    ...
    app.include_router(bet_confirm.router, prefix="", tags=["bet-confirm"])
